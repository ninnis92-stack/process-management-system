...
def upgrade():
    ...
    op.create_table(
        'form_field',
        sa.Column('id', sa.Integer(), primary_key=True),
        sa.Column('template_id', sa.Integer(), sa.ForeignKey('form_template.id'), nullable=False),
    ...
    op.create_table(
        'form_field_option',
        sa.Column('id', sa.Integer(), primary_key=True),
        sa.Column('field_id', sa.Integer(), sa.ForeignKey('form_field.id'), nullable=False),
