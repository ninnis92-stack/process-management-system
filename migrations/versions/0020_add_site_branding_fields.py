...
def upgrade():
    op.add_column('site_config', sa.Column('brand_name', sa.String(length=120), nullable=True))
    op.add_column('site_config', sa.Column('logo_filename', sa.String(length=255), nullable=True))
    op.add_column('site_config', sa.Column('theme_preset', sa.String(length=40), nullable=False, server_default='default'))
