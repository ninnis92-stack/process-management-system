...
def upgrade():
    ...
    if conn.dialect.name == 'sqlite':
        ...
        try:
            op.create_foreign_key('fk_status_bucket_workflow', 'status_bucket', 'workflow', ['workflow_id'], ['id'])
        except Exception:
            pass
...
def downgrade():
    ...
    if conn.dialect.name == 'sqlite':
        ...
        try:
            op.drop_constraint('fk_status_bucket_workflow', 'status_bucket', type_='foreignkey')
        except Exception:
            pass
