...
// camera helpers now live in frontend/js/modules/camera.js and are bundled by Vite
...
// theme engine now lives in frontend/js/modules/theme.js and is bundled by Vite
// listen for cross-tab notifications that feature flags changed
window.addEventListener('storage', (ev) => {
  if (ev.key === 'featureFlagsLastUpdate') {
    try { location.reload(); } catch (e) { /* ignore */ }
