...
- 2026-03-08 UTC: dark-mode class is now applied server‑side based on a user preference flag.  System color-scheme is explicitly ignored so that user toggling always results in a visual change; this avoids confusion when the OS is already dark.
